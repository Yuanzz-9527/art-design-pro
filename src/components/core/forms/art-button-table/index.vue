...
<script setup lang="ts">
  ...
  interface Props {
    /** 按钮类型 */
    type?: 'add' | 'edit' | 'delete' | 'more' | 'view' | 'sync' | 'download'
    /** 按钮图标 */
    icon?: string
    /** 按钮样式类 */
  ...
  const defaultButtons = {
    ...
    more: { icon: '&#xe6df;', color: BgColorEnum.INFO },
    sync: { icon: '&#xe614;', color: BgColorEnum.SUCCESS },
    download: { icon: '&#xe78e;', color: BgColorEnum.PRIMARY }
  } as const
